...
cv2.circle(image, rand_pt(), 40, (255,170,170), cv2.LINE_AA)

cv2.line(image, rand_pt(), rand_pt(), (0, 255, 0))
cv2.line(image, rand_pt(), rand_pt(), (85, 255, 85), 2)
...
cv2.putText(image, 'OpneCV', rand_pt(), cv2.FONT_HERSHEY_SIMPLEX, 1, (0,0,0), 3)
